...
export class Camera2D {
  ...
  disable() {
    ...
    // (Optional: usually layout() handles this, but it doesn't hurt to have it here)
    this.world.scale.set(1);
    this.world.position.set(0, 0);
  }

  // ✅ FIX: This is now outside the disable() function
  public get isEnabled(): boolean {
    return this.enabled; // ✅ FIX: Use 'this.enabled', not '_enabled'
  }
