...
export async function showInfoModal() {
  ...
  const body = new Text(
    "Infection spreads rapidly – survive as long as you can!\n\n" +
      ...
      "• Infect other players with E as a zombie\n" +
      "• Parry the infected with P as a survivor\n" +
      "• Collect powerUps to boost yourself\n" +
      "• After 5 minutes, the game will end\n" +
      "• You can rebind these keys in the settings menu\n\n" +
